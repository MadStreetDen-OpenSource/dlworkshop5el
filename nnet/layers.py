...
class Layer(object):
    """
     ...
     Defines layer functions like fprop, bprop.
    """
...
class ParamMixin(object):
    """
     Abstract Layer Params class
     Defines get functions for layer params.
    """
...
class Linear(Layer, ParamMixin):
    """ Implements a Fully Connected/InnerProduct/Linear Layer """

    def __init__(self, n_out, weight_scale, weight_decay=0.0):
        """
        Init a Linear layer
        :param n_out: Number of neurons
        :param weight_scale: Sigma of normal distribution for weight initialization
        :param weight_decay: Weight decay factor
        :return:
        """
        self.n_out = n_out  # Number of outputs
        self.weight_scale = weight_scale  # Random initialization - normal distribution scale
...
class Activation(Layer):
    """
     Implementation of an Activation function Layer
     Supports Sigmoid, Tanh and ReLU activation functions
    """
